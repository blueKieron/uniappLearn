<template>
  <view class="goods-detail">
    <swiper indicator-dots>
      <swiper-item v-for="(item, index) in detail.pics" :key="index"><image :src="item.pics_big"></image></swiper-item>
    </swiper>
    <view class="box1">
      <view class="price">
    ...
    <view class="box2">
      <view>货号：{{ detail.goods_id }}</view>
      <view>库存：{{ detail.goods_number }}</view>
    </view>
    <view class="line"></view>
    <view class="box3">
      <view class="tit">详情介绍</view>
      <view class="content"><rich-text :nodes="detail.goods_introduce"></rich-text></view>
    </view>
